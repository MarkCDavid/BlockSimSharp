...
public abstract class BaseContextFactory<TTransaction, TBlock, TNode, TNetwork, TConsensus, TEvent, TScheduler, TContext>
...
{
    public abstract TContext BuildContext();
}